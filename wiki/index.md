...
| [rc1-input-authority-retry.md](topics/rc1-input-authority-retry.md) | 固定rc.1：输入身份/取消、RPC路径一致性、重试与授权；锚点 connection/src/rpc-host.ts、session-controller/src/commands.ts（verified_inference / fresh）。 | L2 | 17 |
