...
- [1.5-rc.2 工具与外部效果边界](topics/rc15-tool-effect-boundaries.md)：审批forward/prepend顺序、ToolFS attachments隔离、Shell/FS效果限制；锚点 tools/src/index.ts、fs-local/src/fsio.ts（verified_inference / fresh）。
